...
describe('ArticleDetailsSlice', () => {
    test('fetchArticleById.pending', () => {
        ...
        expect(articleDetailsReducer(state, fetchArticleById.pending)).toEqual({isLoading:true, error: undefined})
    })
    ...
    test('fetchArticleById.fulfilled', () => {
        ...
        expect(articleDetailsReducer(state , fetchArticleById.fulfilled(data, "", ''))).toEqual({isLoading:false, data})
    })
    ...
    test('fetchArticleById.rejected', () => {
        ...
        expect(articleDetailsReducer(state, fetchArticleById.rejected)).toEqual({isLoading:false, error:undefined})
    })
})